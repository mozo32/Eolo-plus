...
import { Pill, History, UserPlus, Archive, PackagePlus } from 'lucide-react';
                    ...
                    <div className="flex flex-wrap bg-slate-100 p-1.5 rounded-2xl gap-1">
                        {tabs.map((tab) => (
                            <button
                                ...
                                className={`px-5 py-2.5 rounded-xl font-bold transition-all uppercase text-xs md:text-sm ${
                                    view === tab.key
