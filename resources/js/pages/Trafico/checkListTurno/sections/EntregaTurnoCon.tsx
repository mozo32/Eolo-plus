...
// Definimos los mismos iconos para mantener la coherencia visual
const EQUIPOS = [
    {
        id: "areas_limpias",
        label: "Áreas Limpias",
            ...
            <div className="relative">
                ...
                <div className="grid grid-cols-2 gap-3 sm:grid-cols-3 lg:grid-cols-4">
                    {EQUIPOS.map(({ id, label, icon }) => {
                        const isChecked = !!form.entregaTurnoCon?.[id];
                        return (
                            <button
                                key={id}
                                type="button"
                            ...
                            >
                                {/* Indicador de Check superior derecho */}
