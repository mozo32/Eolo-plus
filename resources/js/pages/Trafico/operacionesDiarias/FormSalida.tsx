...
export const FormSalida = ({ alCerrar, moduloNombre, datosEdicion, soloLectura = false }: {
    ...
    return (
        <form onSubmit={handleSubmit} className="bg-white p-6 rounded-xl border-t-8 border-orange-600 shadow-sm w-full mb-6">
                ...
                <div className="flex gap-3 pt-4">
                    ...
                    {!soloLectura && (
                        <button
                            type="submit"
                            disabled={cargando}
                            className={`flex-1 px-4 py-3 rounded-lg font-bold shadow-lg transition-all ${cargando ? 'bg-orange-400 cursor-not-allowed scale-95' : 'bg-orange-600 hover:bg-orange-700 text-white active:scale-95'}`}
                        >
