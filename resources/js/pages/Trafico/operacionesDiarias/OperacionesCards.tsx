        ...
        <div className="bg-[#f3f4f6] min-h-screen p-4 font-sans text-slate-900 relative">
            ...
            <div className="max-w-6xl mx-auto space-y-2">
                <div className="grid grid-cols-12 px-6 py-2 text-[10px] font-bold text-slate-400 uppercase tracking-widest">
                    ...
                    <div className="col-span-1 text-center">Matrícula</div>
                        ...
                        return (
                            <div key={op.id} className={`transition-all duration-300 ${stripExpandida === op.id ? 'ring-2 ring-blue-500 my-4' : 'hover:bg-slate-50'}`}>
                                <div
                                    ...
                                    className="grid grid-cols-12 items-center border border-slate-200 p-4 rounded-lg cursor-pointer shadow-sm bg-white"
                                >
                                    ...
                                    <div className="col-span-1 font-black text-lg uppercase tracking-tighter text-center">{op.matricula}</div>
                                        ...
                                        <div className="max-w-3xl mx-auto">
                                            {op.validaciones?.includes(moduloNombre) ? (
                                                <div className="bg-slate-50 border-2 border-dashed border-green-200 rounded-xl p-8 text-center">
                                                    ...
                                                    <p className="text-sm text-slate-500 mt-1">Confirmado por <span className="font-bold text-slate-700">{moduloNombre}</span>.</p>
                                                    <button onClick={() => setStripExpandida(null)} className="mt-4 text-xs font-bold text-blue-600 hover:underline">CERRAR DETALLES</button>
                                                </div>
                                            ) : (
                                                <>
                                                    {op.tipo === 'llegada' ? (
