...
import WalkAroundResumen from "./WalkAroundResumen";
...
export default function WalkAroundFirmaModal({ id, open, onClose, onSaved }: Props) {
        ...
        const load = async () => {
            ...
            try {
                ...
                Swal.fire({
                    icon: "error",
                    title: "Error",
                    text: e?.message || "No se pudo cargar el registro para firmar",
                });
                onClose();
            } finally {
                setLoading(false);
                    ...
                    <div className="space-y-6">
                        ...
                        <WalkAroundFirma
                            initialData={{
                                ...
                                jefeArea: detalle.jefe_area ?? "",
                                fbo: detalle.fbo ?? "",
                                firmaResponsableBase64: initialData.firmaResponsableBase64,
                                firmaJefeAreaBase64: initialData.firmaJefeAreaBase64,
                                firmaFboBase64: initialData.firmaFboBase64,
                            }}
                            onClose={onClose}
                            onSaved={(data) => {
                                // aquí llamas a tu API de firmas
                                onSaved?.();
                            }}
                        />
                    </div>
