...
import { X, Send, Settings, Link } from 'lucide-react';
...
export default function ModalPrefactura({ isOpen, onClose, onSend, row }: Props) {
    const [prefactura, setPrefactura] = useState(row?.prefactura || '');
            ...
            <div className="w-full max-w-md scale-100 rounded-3xl bg-white p-6 shadow-2xl animate-in zoom-in-95 duration-300">
                <div className="flex items-center justify-between mb-6">
                    <div className="flex items-center gap-3">
                        ...
                        <div>
                            <h3 className="text-lg font-bold text-slate-900">Vincular a prefactura</h3>
